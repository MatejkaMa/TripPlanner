...
extension CityConnection {
    static var mock: CityConnection {
        return .init(from: .init(name: "London", coordinate: .init(lat: 1, long: 1)), to: .init(name: "LA", coordinate: .init(lat: 1, long: 1)), price: 200, children: nil)
    }
}
...
extension Sequence where Element == CityConnection {
    static var mock: [CityConnection] {
        [
            .init(from: .init(name: "London", coordinate: .init(lat: 0, long: 0)), to: .init(name: "LA", coordinate: .init(lat: 1, long: 1)), price: 100, children: [.init(from: .init(name: "London", coordinate: .init(lat: 0, long: 0)), to: .init(name: "New York", coordinate: .init(lat: 0.5, long: 0.5)), price: 80, children: nil)]),
            .init(from: .init(name: "London", coordinate: .init(lat: 1, long: 1)), to: .init(name: "LA", coordinate: .init(lat: 1, long: 1)), price: 200, children: nil)
        ]
    }
}
#endif
    ...
    struct FlightConnectionsList_Previews: PreviewProvider {
        ...
        static var previews: some View {
            FlightConnectionsList(
                viewModel: .init([], from: Just(nil).eraseToAnyPublisher(), to: Just(nil).eraseToAnyPublisher(), onSelect: { _ in }),
